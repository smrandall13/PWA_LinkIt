...
!(function (t, n) {
	...
	function X(t, n, e) {
		...
		let u, c, f;
		return i < 0 ? ((f = Math.pow(10, -i) / a), (u = Math.round(t * f)), (c = Math.round(n * f)), u / f < t && ++u, c / f > n && --c, (f = -f)) : ((f = Math.pow(10, i) * a), (u = Math.round(t / f)), (c = Math.round(n / f)), u * f < t && ++u, c * f > n && --c), c < u && 0.5 <= e && e < 2 ? X(t, n, 2 * e) : [u, c, f];
	}
	function G(t, n, e) {
		if (!((e = +e) > 0)) return [];
		if ((t = +t) === (n = +n)) return [t];
	...
	function Q() {
		...
		function r(r) {
			...
			if (isFinite(a)) {
				if (a > 0) for (i = 0; i < u; ++i) null != (o = c[i]) && l <= o && o <= h && _[Math.min(p, Math.floor((o - l) / a))].push(r[i]);
				else if (a < 0)
					for (i = 0; i < u; ++i)
	...
	var qt = 'http://www.w3.org/1999/xhtml',
		Ut = { svg: 'http://www.w3.org/2000/svg', xhtml: qt, xlink: 'http://www.w3.org/1999/xlink', xml: 'http://www.w3.org/XML/1998/namespace', xmlns: 'http://www.w3.org/2000/xmlns/' };
	function It(t) {
		var n = (t += ''),
			e = n.indexOf(':');
		return e >= 0 && 'xmlns' !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), Ut.hasOwnProperty(n) ? { space: Ut[n], local: t } : t;
	}
	function Ot(t) {
		return function () {
	...
	function ze(t) {
		...
		return (
			...
			(n = we.exec(t))
				? ((e = n[1].length), (n = parseInt(n[1], 16)), 6 === e ? $e(n) : 3 === e ? new qe(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1) : 8 === e ? De((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255) : 4 === e ? De(((n >> 12) & 15) | ((n >> 8) & 240), ((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), (((15 & n) << 4) | (15 & n)) / 255) : null)
				: (n = Me.exec(t))
	...
	function je(t) {
		...
		var n = (t = t.rgb()).r / 255,
			...
			u = o - i,
			c = (o + i) / 2;
		return u ? ((a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4), (u /= c < 0.5 ? o + i : 2 - o - i), (a *= 60)) : (u = c > 0 && c < 1 ? 0 : a), new Xe(a, u, c, t.opacity);
	}
	function He(t, n, e, r) {
	...
	function or(t) {
		...
		return r === i && i === o ? (n = e = a) : ((n = cr((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Qe)), (e = cr((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / tr))), new ur(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity);
	}
	function ar(t, n, e, r) {
	...
	pe(
		...
		ge(ye, {
			...
			rgb() {
				...
				return new qe(sr(3.1338561 * (n = Qe * fr(n)) - 1.6168667 * (t = Je * fr(t)) - 0.4906146 * (e = tr * fr(e))), sr(-0.9787684 * n + 1.9161415 * t + 0.033454 * e), sr(0.0719453 * n - 0.2289914 * t + 1.4052427 * e), this.opacity);
			},
		})
	),
		pe(
	...
	function Xr(t, n) {
		var e,
			...
			u = [],
			c = [];
		for (t += '', n += ''; (e = jr.exec(t)) && (r = Hr.exec(n)); ) (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)), (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), c.push({ i: a, x: Yr(e, r) })), (o = Hr.lastIndex);
		return (
	...
	function Qr(t, n, e, r, i, o) {
		var a, u, c;
		return (a = Math.sqrt(t * t + n * n)) && ((t /= a), (n /= a)), (c = t * e + n * r) && ((e -= t * c), (r -= n * c)), (u = Math.sqrt(e * e + r * r)) && ((e /= u), (r /= u), (c /= u)), t * r < n * e && ((t = -t), (n = -n), (c = -c), (a = -a)), { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Zr, skewX: Math.atan(c) * Zr, scaleX: a, scaleY: u };
	}
	function Jr(t, n, e, r) {
		function i(t) {
		...
		return function (o, a) {
			...
			return (
				...
				(function (t, n, e, o) {
					t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + 'rotate(', null, r) - 2, x: Yr(t, n) })) : n && e.push(i(e) + 'rotate(' + n + r);
				})(o.rotate, a.rotate, u, c),
				(function (t, n, e, o) {
					t !== n ? o.push({ i: e.push(i(e) + 'skewX(', null, r) - 2, x: Yr(t, n) }) : n && e.push(i(e) + 'skewX(' + n + r);
				})(o.skewX, a.skewX, u, c),
	...
	function Li(t, n, e, r, i, o) {
		...
		})(t, e, { name: n, index: r, group: i, on: Di, tween: Ri, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: Fi });
	}
	function ji(t, n) {
		var e = Xi(t, n);
	...
	var fa = {
		...
		ha = { overlay: 'crosshair', selection: 'move', n: 'ns-resize', e: 'ew-resize', s: 'ns-resize', w: 'ew-resize', nw: 'nwse-resize', ne: 'nesw-resize', se: 'nwse-resize', sw: 'nesw-resize' },
	...
	function wa(t) {
		...
		function h(e) {
			...
			function I(t) {
				...
				h < a && ((x *= -1), (r = i), (i = l), (l = r), (r = a), (a = h), (h = r), b in da && F.attr('cursor', ha[(b = da[b])])),
					p < c && ((w *= -1), (r = u), (u = d), (d = r), (r = c), (c = p), (p = r), b in pa && F.attr('cursor', ha[(b = pa[b])])),
		...
		return (
			...
			(l.prototype = {
				...
				emit: function (n, e, r) {
					...
					a.call(n, this.that, new Qo(n, { sourceEvent: e, target: c, selection: t.output(this.state.selection), mode: r, dispatch: a }), i);
				},
			}),
			(c.extent = function (t) {
	...
	(Fc.copy = function () {
		...
		for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); ) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Rc(n)));
		return e;
	}),
		(Fc.add = function (t) {
	...
	function Jc(t) {
		...
		var n;
		return new tf({ fill: n[1], align: n[2], sign: n[3], symbol: n[4], zero: n[5], width: n[6], comma: n[7], precision: n[8] && n[8].slice(1), trim: n[9], type: n[10] });
	}
	function tf(t) {
			...
			return {
				...
				point: function (o, a) {
					var u = o > 0 ? gf : -gf,
						c = xf(o - e);
					xf(c - gf) < df
						? (t.point(e, (r = (r + a) / 2 > 0 ? yf : -yf)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), (n = 0))
						: i !== u &&
						  c >= gf &&
						  (xf(e - i) < df && (e -= i * df),
						  xf(o - u) < df && (o -= u * df),
					...
					function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
						...
						if (b > 4 * n && g--) {
							var m = a + h,
								...
								C = N - i,
								P = _ * k - v * C;
							((P * P) / b > n || xf((v * k + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < hd) && (e(r, i, o, a, u, c, E, N, A, (m /= M), (x /= M), w, g, y), y.point(E, N), e(E, N, A, m, x, w, f, s, l, h, d, p, g, y));
						}
					}
					return function (n) {
						var r,
	...
	function vd(t) {
		...
		return (
			...
			(E.clipExtent = function (t) {
				return arguments.length
					? ((A = null == t ? ((T = r = i = o = null), eh) : zl((T = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))), C())
					: null == T
					? null
					: [
							[T, r],
	...
	function Vg(t, n, e, r) {
		...
		return (
			...
			e && ((i.count = (n, r) => (Xg.setTime(+n), Gg.setTime(+r), t(Xg), t(Gg), Math.floor(e(Xg, Gg)))), (i.every = (t) => ((t = Math.floor(t)), isFinite(t) && t > 0 ? (t > 1 ? i.filter(r ? (n) => r(n) % t == 0 : (n) => i.count(0, n) % t == 0) : i) : null))),
			i
		);
	}
	const Wg = Vg(
	...
	function Rm(t, n, e, r, i, o, a) {
		var u = t - e,
			...
			C = S - y,
			P = E - v;
		return N * N + k * k > C * C + P * P && ((T = S), (A = E)), { cx: T, cy: A, x01: -s, y01: -l, x11: T * (i / x - 1), y11: A * (i / x - 1) };
	}
		...
		(fw.prototype = {
			...
			lineEnd: function () {
				...
				if (e)
					...
					else for (var r = sw(t), i = sw(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
	...
	(Tw.prototype = ww.prototype),
		...
		(t.drag = function () {
			...
			function b(t, n, e, r, i, o) {
				var u,
					...
					p = f.copy(),
					g = ne(o || e, n);
				if (null != (d = a.call(t, new fe('beforestart', { sourceEvent: e, target: h, identifier: i, active: s, x: g[0], y: g[1], dx: 0, dy: 0, dispatch: p }), r)))
					return (
						(u = d.x - g[0] || 0),
						(l = d.y - g[1] || 0),
						function e(o, a, f) {
							...
							p.call(o, t, new fe(o, { sourceEvent: a, subject: d, target: h, identifier: i, active: y, x: g[0] + u, y: g[1] + l, dx: g[0] - v[0], dy: g[1] - v[1], dispatch: p }), r);
						}
					);
			}
			return (
		...
		(t.geoCircle = function () {
			...
			function a() {
				...
				return (t = []), (n = ul(-a[0] * mf, -a[1] * mf, 0).invert), hl(o, u, c, 1), (a = { type: 'Polygon', coordinates: [t] }), (t = n = null), a;
			}
			return (
				(a.center = function (t) {
		...
		(t.geoIdentity = function () {
			...
			return (
				...
				(b.clipExtent = function (t) {
					return arguments.length
						? ((v = null == t ? ((d = e = r = i = null), eh) : zl((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))), _())
						: null == d
						? null
						: [
								[d, e],
		...
		(t.interpolateSinebow = function (t) {
			var n;
			return (t = (0.5 - t) * Math.PI), (cm.r = 255 * (n = Math.sin(t)) * n), (cm.g = 255 * (n = Math.sin(t + fm)) * n), (cm.b = 255 * (n = Math.sin(t + sm)) * n), cm + '';
		}),
			...
			return (
				...
				(M.prototype = {
					...
					emit: function (t) {
						...
						h.call(t, this.that, new xw(t, { sourceEvent: this.sourceEvent, target: v, type: t, transform: this.that.__zoom, dispatch: h }), n);
					},
				}),
